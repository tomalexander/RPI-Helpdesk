...
\begin{enumerate}
\item Disconnect from Switch B. Update Microsoft's Antivirus by double-clicking the green Microsoft Forefront Endpoint Protection icon, selecting the Update tab, and clicking the Update button.
...
By default, the wireless is sometimes disabled. If you wish to enable it, press \emph{Fn + F8} and select the desired option.
\subsection{{\sc optional} Enable Wireless}
By default, the touchpad is sometimes disabled. If you wish to enable it, press \emph{Fn + F5} and ensure wireless is enabled.
%\begin{enumerate}
